...
ui-server:
	DASH_TELEMETRY_ADDRESS=telemetry.corp.heptio.net:443 DASH_DISABLE_OPEN_BROWSER=false DASH_LISTENER_ADDR=localhost:3001 $(GOCMD) run ./cmd/apt/main.go dash $(DASH_FLAGS)
